...
exports.createPages = async ({ graphql, actions }) => {
  ...
  const portfolioUnderContentTemplate = path.resolve(`./src/pages/templates/portfolioUnderContent.js`)
  ...
  const portfolioTemplate = path.resolve(`./src/pages/templates/portfolio.js`)
